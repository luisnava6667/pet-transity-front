...
const FormRegisterUser = () => {
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      mascotas: Yup.string().required("Campo requerido"),
      hogar: Yup.string().required("Campo requerido"),
      ambientes: Yup.number().required("Campo requerido"),
      patio_jardin: Yup.string().required("Campo requerido"),
      estado_domicilio: Yup.string().required("Estado del domicilio requerido"),
    ...
    onSubmit: (values) => {
      ...
      /*  axios
        .post(`https://giant-jersey-colt.cyclic.app/${selectedButton}`, values)
        .then((res) => {
