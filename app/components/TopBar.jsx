    ...
    <div className="mx-auto w-full py-14 bg-[#6F4C48] flex h-20  items-center gap-8 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-1 items-center justify-end md:justify-between">
        ...
        <div className="flex  items-center gap-4">
          <div class="relative border-2 rounded-full border-black border-opacity-40  ">
            <input
              class="h-10 w-full rounded-full border-none bg-white bg-opacity-30 pe-10 ps-4 text-sm shadow-sm sm:w-[29rem] text-[#303030] placeholder:text-[#303030] focus:outline-none "
              id="search"
              type="search"
